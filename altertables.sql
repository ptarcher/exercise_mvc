...
CREATE TABLE t_exercise_periods
(
...
(
   ...
   CONSTRAINT t_exercise_plans_weekly_fk_period FOREIGN KEY (period) REFERENCES t_exercise_periods (period) ON UPDATE NO ACTION ON DELETE NO ACTION
) 
WITH (
  OIDS = FALSE
)
