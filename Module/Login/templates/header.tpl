...
<head>
	...
	<link rel="shortcut icon" href="Module/CoreHome/templates/images/favicon.ico" />

	<link rel="stylesheet" type="text/css" href="Module/Login/templates/login.css" media="screen" />
